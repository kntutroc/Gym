...
class StrengthCardioRoutineActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_strength_cardio_routine)
        ...
        fetchAssistedExercises()
    }

    private fun fetchAssistedExercises() {
        val client = OkHttpClient()

        val request = Request.Builder()
            .url("https://exercisedb.p.rapidapi.com/exercises/equipment/assisted?limit=10")
            .get()
